    ...
    <div class="flex overflow-hidden">
        ...
        <div class="content" id="app" v-cloak>
            ...
            @if (App\Helpers\GitVersionHelper::version())
                <footer>
                    <div class=" py-1 text-sm text-grey-500 text-center"><a
                            href="https://github.com/anonaddy/anonaddy/releases/tag/v{{ App\Helpers\GitVersionHelper::version() }}"
                            target="_blank" rel="nofollow noreferrer noopener"
                            class="block sm:inline">v{{ App\Helpers\GitVersionHelper::version() }}</a></div>
                </footer>
            @endif
